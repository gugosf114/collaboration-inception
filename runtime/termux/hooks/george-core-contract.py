#!/usr/bin/env python3
"""Return George's four global rules for every submitted prompt."""
...
CONTRACT = """Current-turn developer instruction. Apply George's four global rules. They override any general default to assume unclear meaning.
